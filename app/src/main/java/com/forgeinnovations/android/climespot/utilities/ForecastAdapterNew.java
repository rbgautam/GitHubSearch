...
public class ForecastAdapterNew extends RecyclerView.Adapter<ForecastAdapterNew.ForecastAdapterViewHolder> {
     ...
     */
    final private ForecastAdapterNewOnClickHandler mClickHandler;

    /**
     * The interface that receives onClick messages.
     */
    public interface ForecastAdapterNewOnClickHandler {
        void onClick(RecycleViewItem itemData);
    }
    ...
    private List<RecycleViewItem> mWeatherData;
     ...
     */
    public ForecastAdapterNew(@NonNull Context context, ForecastAdapterNewOnClickHandler clickHandler) {
        mContext = context;
    ...
    public void onBindViewHolder(ForecastAdapterViewHolder forecastAdapterViewHolder, int position) {
         ...
         * Weather Icon *
         ****************/
        int weatherId = itemData.WeatherId;
        int weatherImageId;
        ...
        long dateInMillis = itemData.WeatherDate;
        /* Get human readable string using our utility method */
        //String dateString = SunshineDateUtils.getFriendlyDateString(mContext, dateInMillis, false);
        String dateString = SunshineDateUtils.convertMillistoDate(itemData.Datestr);
         ...
         * Weather Description *
         ***********************/
        String description = itemData.WeatherDescription;
        ...
        double highInCelsius = itemData.MaxTemp;
        /*
        ...
        double lowInCelsius = itemData.MinTemp;
        /*
         * If the user's preference for weather is fahrenheit, formatTemperature will convert
         * the temperature. This method will also append either °C or °F to the temperature
         * String.
    ...
    public int getItemCount() {
        if (null == mWeatherData || mWeatherData.size() ==0) return 0;
     ...
     */
    public void swapCursor(List<RecycleViewItem> newCursor) {
        //mCursor = newCursor;
        mWeatherData = newCursor;
    ...
    class ForecastAdapterViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            RecycleViewItem itemData =  mWeatherData.get(adapterPosition);
            long dateInMillis = itemData.WeatherDate;
